...
export const entityStartIndex = [
  ...
  { startIndex: 9, modelname: 'obj_sofa' },
  ...
  { startIndex: 9, modelname: 'obj_puffer' },
...
export const animation = 'models/emote_sit.glb'
