...
import { cleanString, getTitleFontSize, wordWrap } from './helperFunctions'
...
// import { TrackingElement, generateGUID, trackAction } from '../modules/stats/analyticsComponents'
...
export class CrowdMenuItem extends MenuItem {
  ...
  userCount: number
  scene: any
  defaultItemScale: Vector3.MutableVector3
  ...
  show() {
    ...
    Transform.getMutable(this.detailsRoot).scale = Vector3.One()
  ...
  hide() {
    ...
    Transform.getMutable(this.detailsRoot).scale = Vector3.Zero()
