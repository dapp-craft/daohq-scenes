...
export class HorizontalMenu {
    ...
    menuRoot:Entity = engine.addEntity()
    audioRoot:Entity
    spacing:number
    angleSpacing:number
    scrollerRoot:Entity
    ...
    constructor(_position:Vector3, _rotation:Quaternion, _menuManager:MenuManager, _id:number){
      this.menuID = _id
      this.menuManagerRef = _menuManager
        this.spacing = 3.3
        this.angleSpacing = 32
        this.items = []
        this.itemRoots = []
        this.clickBoxes = []
        this.radius = 6
        this.visibleItems = 2        // this.analyticParent = _analyticParent
        ...
        VisibilityComponent.create(this.leftHoverArrow, {visible:true})
        ...
        VisibilityComponent.create(this.rightHoverArrow, {visible:true})
